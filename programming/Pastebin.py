            ...
            try:
                ...
                if r.status_code == 200:
                    ...
                    try:
                        ...
                        account["profile_creation_date"] = {"name": "Creation Date",
                                                            "value": user_profile_creation_date}
                    except:
                        self.log.error(f'Error en la búsqueda de información de {username} en pastebin')
                    ...
                    try:
                        ...
                        self.log.error(f'Error en la búsqueda de publicaciones de {username} en pastebin')

                    # Append the account to the accounts table
                    pastebin_usernames["accounts"].append(account)

            except requests.ConnectionError:
                self.log.error('Error al realizar la petición a pastebin')
